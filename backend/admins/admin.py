...
admin.site.register(GeneralBlogs)
admin.site.register(BlogsContents)
admin.site.register(GeneralBlogsContents)
...
admin.site.register(GeneralUserFileAssociation)
...
admin.site.register(Podcastfcpipodcast)
