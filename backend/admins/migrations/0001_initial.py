    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speakers', models.ManyToManyField(blank=True, related_name='events', to='admins.speaker')),
            ],
        ),
        migrations.CreateModel(
            name='Blogs',
            fields=[
                ...
                ('qualification', models.CharField(max_length=100)),
                ('date', models.DateField(null=True)),
                ('blog_contents', models.ManyToManyField(blank=True, related_name='blog_contents', to='admins.blogscontents')),
