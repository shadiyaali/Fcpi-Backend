...
from.models import Forum,Speaker,Event,SingleEvent,Gallery,GeneralAttachment,Podcast,HostContents,GuestContents,GeneralEvent,GeneralUserFileAssociation,Newsletter,GeneralCertificates,GeneralSingleEvent,GeneralMultiEvent,Attachment,GeneralBlogsContents,GeneralBlogs,UserFileAssociation,MultiEvent,Member,ForumMember,BlogsContents,Blogs,Certificates,Banner,News,BoardMember,Board
...
class GeneralEventUpdateAPIView(APIView):
    def put(self, request, *args, **kwargs):
        ...
        try:
            event = GeneralEvent.objects.get(id=event_id)
        ...
        try:
            ...
            for multi_event_data in multi_events_data:
                ...
                multi_event = GeneralMultiEvent.objects.create(
                    single_event=single_event,
                    starting_time=multi_event_data.get('starting_time'),
                    ending_time=multi_event_data.get('ending_time'),
                    topics=multi_event_data.get('topics'),
